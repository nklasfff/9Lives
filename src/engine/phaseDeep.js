// Deep phase content — extracted from the book, one phase at a time
...
const PHASE_DEEP = {
  ...
  7: {
    ...
    bodyInBalance: {
      ...
      body: 'A woman in balance in this phase carries a quiet authority that is hard to name but everyone can feel. She knows her own worth, and the confirmation of others matters less than before. Her breathing is deep and free, and there is a clarity in her skin, in her gaze, in the way she speaks. She says what she means, and she is silent when something deserves silence.',
    },

    bodyImbalanced: {
      title: 'When the Body Is Challenged',
      physical: [
        'Menopause symptoms: hot flashes, night sweats, sleep disturbances — often strongest in the early phase',
        'Skin becomes drier, thinner, more sensitive — Metal\'s body tissue speaks clearly now',
        'Breathing feels shorter and more shallow, especially during stress',
        'More frequent colds or tendency toward coughing — the Lungs are under pressure',
        'Digestion works harder, constipation or bloating — the Large Intestine asks for attention',
    ...
    exercises: [
      {
        ...
        body: 'Sit or stand with an open chest — roll your shoulders back. Breathe in through the nose for four counts, feeling the ribs expand sideways. Hold for two counts. Exhale slowly through the mouth for eight counts. Add a gentle "ssss" sound to the exhale — Metal\'s healing sound in Chinese medicine. Repeat eight to ten times.',
      },
      {
        title: 'Lung Meridian Stroking',
        body: 'The Lung meridian runs from the chest along the inner arm to the thumb. Stand upright, lift one arm to the side at shoulder height, palm up. Stroke with the other hand from the chest — just below the collarbone — down the inner arm to the thumb. Five to seven times on each arm.',
      },
      {
        title: 'Yin Yoga: Sphinx with Opening',
        body: 'Lie on your belly in sphinx pose — elbows under shoulders, forearms on the floor. Slowly roll your shoulders back and lift the chest slightly, feeling an opening in the front of the chest where the Lungs sit. Two to three minutes. Add Metal\'s "ssss" sound on the exhale.',
      },
      {
        title: 'Mind: What Can You Release?',
        body: 'Take a notebook. Write two lists. The first: what I carry — roles, responsibilities, worries, obligations, habits, beliefs about who you should be. The second: what I can put down. Read the first list and feel into each item — is this mine to carry? Move what can be released to the second list.',
      },
      {
        title: 'The Harvest Walk',
        body: 'Walk outside — slowly, without music, without phone. Half your normal pace. Feel the air against your face and in your nose. While walking, feel into: what have you harvested in your life? What do you carry that still nourishes you? And what have you been carrying that has served its purpose? Ten to fifteen minutes is enough.',
      },
    ],

    diet: {
      title: 'Diet and Body',
      intro: 'Diet in this phase should support the Lungs and Large Intestine and counteract the dryness that follows both the Metal element and the hormonal transition. It is about moistening, nourishing, and cleansing — three movements that follow Metal\'s own rhythm.',
      foods: [
        { category: 'Metal-supporting foods', items: 'White foods nourish the Lungs — cauliflower, celery, pears, rice, and almonds. Soups and porridge moisten and warm. Pears cooked with ginger and honey is a classic remedy.' },
        { category: 'Herbs and spices', items: 'Sharp spices in moderation — ginger, garlic, onion, horseradish — support Metal\'s energy. Thyme and sage are classic Lung herbs. Sage tea can help with hot flashes and night sweats.' },
        { category: 'Bone health', items: 'Calcium-rich foods: almonds, sesame seeds, leafy greens, sardines. Vitamin D from sunlight. Strengthening the foundation that must carry you the rest of your life.' },
        { category: 'Reduce', items: 'Too dry or raw food requires extra energy to digest. Caffeine can trigger hot flashes — experiment and notice. Your body speaks clearly in this phase about what it wants and what it rejects.' },
      ],
    },

    themes: [
      {
        title: 'Harvesting What Was Sown',
        body: 'This phase invites you to pause and look back — with recognition. What have you created in your life? What have you built, nourished, cultivated? For many women, this is a time when they finally find peace in what they have accomplished, instead of constantly searching for the next thing.',
      },
      {
  ...
  8: {
    ...
    personal: {
      title: 'A woman once told me:',
      quote: 'It was as though the house finally went quiet inside. All the voices that had been talking for years — what I should do, who I should be — they stopped. And what was left was just me. And the rain.',
      reflection: 'There is something about this phase that resembles winter. The landscape is still. There is a calm over the world that invites you to go inward.',
    },
    ...
    bodyImbalanced: {
      ...
      physical: [
        ...
        'Hearing changes or tinnitus — the ears are Water\'s sense organ',
        'Thinning hair, hair loss, and nails that crack or split',
      ],
      emotional: [
        'A fear that may have been in the background for years but now steps forward more clearly — fear of aging, of loss, of death',
        'A feeling of being invisible, of the world having moved on without you',
        'Lack of motivation, a heaviness that makes it hard to begin',
        'But also glimpses of deep wisdom — moments of clarity where you suddenly see your life as a whole and find peace with what is',
      ],
    },
    ...
    exercises: [
      {
        title: 'Water\'s Breath',
        body: 'Sit or lie comfortably. Place your hands on your lower back, just over the Kidneys, and feel the warmth of your hands against your back. Breathe deeply and imagine the breath flowing like warm water down through the body, gathering in the pelvis. Exhale slowly with a soft "chuuu" sound — Water\'s healing sound. Five to ten minutes. You don\'t need to do anything. Just feel that something is carrying you.',
      },
      {
        title: 'Kidney Meridian Stroking',
        body: 'The Kidney meridian begins under the foot, in the depression behind the ball of the foot (Kidney 1, "The Bubbling Spring"). Sit and place one foot over the opposite knee. Press gently into this point for ten to twenty seconds. Stroke slowly upward along the inner foot, ankle, and shin. Both feet, preferably in the evening before bed.',
      },
      {
      ...
      },
      {
        ...
        body: 'Find a quiet moment with a notebook. Write a letter to yourself — the woman you are right now. Tell her what you have learned. What you are proud of. What you wish you had known earlier. And what you wish for the years ahead. The letter need not be long. Let the words come.',
      },
      {
        title: 'Silent Walk by Water',
        body: 'Walk outside — preferably along water, a lake, a stream, the sea. Walk slowly, without music, without phone. Feel the air and listen — the ears are Water\'s sense organ. Listen to the water if you can hear it. To the wind, the birds, the silence between the sounds. Ten to fifteen minutes is enough.',
      },
    ],
    ...
    diet: {
      ...
      foods: [
        ...
        { category: 'Bone health', items: 'Calcium-rich foods: almonds, sesame seeds, leafy greens, sardines. Vitamin D from sunlight. Weight-bearing exercises keep bones strong. This is about protecting the foundation that must carry you the rest of your life.' },
        { category: 'Reduce', items: 'Cold beverages and raw food burden the Kidneys and cool the body. Excessive salt is as harmful as too little. Caffeine in large amounts depletes adrenal energy. Listen to the body — it speaks clearly in this phase.' },
      ],
    },
    ...
    themes: [
      ...
      },
      {
        ...
        body: 'Chinese medicine describes that when menstruation ceases, blood flows "backwards" from the uterus to the Heart, where Shen — consciousness, spirit — lives. The energy that for decades went to the reproductive system is now available for consciousness. Many women feel it as sharpened intuition, deeper presence, an ability to see patterns they never saw before. That energy is real, and it is yours.',
      },
    ],

    seasons: {
      title: 'The Year\'s Rhythm in the Stillness Years',
      entries: [
        { season: 'Winter', body: 'The season that speaks most directly to you now. Water meets Water, and the still, inward energy of the dark months matches your body\'s own movement toward depth. The dark months that may have felt heavy in younger years can now feel like a friend — a season that speaks exactly the language your body already speaks.' },
        { season: 'Spring', body: 'Water nourishes Wood in the Sheng cycle. The energy you build in stillness flows outward into spring\'s unfolding. Many women in this phase feel a special joy in spring — a sense of renewal that feels deeper than usual. It is a foretaste of the Second Spring waiting in Phase 9.' },
        { season: 'Summer', body: 'Water controls Fire in the Ke cycle, so summer\'s intense, outward energy can feel overwhelming. Find your own rhythm — more shade, more midday rest, and an acceptance that you no longer need to be part of everything. This is Water\'s natural moderation of Fire\'s intensity.' },
        { season: 'Late Summer', body: 'Earth controls Water in the Ke cycle, which can feel like a brief, dense period where the body feels heavier. But late summer\'s ripe fruits and warm days also give concrete nourishment and a well-deserved pause.' },
        { season: 'Autumn', body: 'Metal nourishes Water in the Sheng cycle, and autumn\'s sharpened energy supports your phase\'s deep work. The clarity you built in Phases 6 and 7 now flows into Water\'s depth, giving your introspection direction. Many women experience autumn as an especially fruitful time for reflection.' },
      ],
    },

    reflections: [
      'What happens when you truly let yourself be still?',
      'Who are you when all the roles are laid aside?',
      'What has your life taught you that no book could have?',
      'When do you feel wisdom in your own body — those moments where you know something without being able to explain why?',
      'What will you pass on? And what will you keep for yourself?',
    ],
...
export function getPhaseDeep(phaseNumber) {
  return PHASE_DEEP[phaseNumber] || null;
}
